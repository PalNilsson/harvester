...
class DaskSubmitterBase(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._images = {
            'dask-scheduler': 'europe-west1-docker.pkg.dev/gke-dev-311213/dask-images/dask-scheduler:test',  # default
            'dask-scheduler-ml': 'europe-west1-docker.pkg.dev/gke-dev-311213/dask-images/dask-scheduler-ml:latest',
            'dask-worker': 'europe-west1-docker.pkg.dev/gke-dev-311213/dask-images/dask-worker:test',  # default
...
#            'jupyterlab': 'europe-west1-docker.pkg.dev/gke-dev-311213/dask-images/datascience-notebook:latest',
            'jupyterlab': 'europe-west1-docker.pkg.dev/gke-dev-311213/dask-images/jupyter-pyroot:test2',
